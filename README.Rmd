...
Docker runs the app in a container - perfect if you don't have R installed.
...
Download the [Dockerfile](https://raw.githubusercontent.com/cimentadaj/lifetableprojection/main/Dockerfile) and save it to a folder (e.g., your Desktop).
